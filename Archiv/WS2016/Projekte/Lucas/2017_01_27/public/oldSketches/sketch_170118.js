...
var tempo = setInterval(wordTimer, 300);
...
function Frame (x, y, sizeX, sizeY) {
  ...
  this.display = function () {
    ...
    //  set font values
    ctx.font = "" + this.sizeY * 1.5 + "px Archivo Narrow";
    ctx.textAlign = "center"

    //  draw text
    fill(0);
    background(255);
    ctx.fillText(tweetsDisplayed[tweetIndex - 1].words[wordIndex].toUpperCase(), this.sizeX / 2, this.sizeY, this.sizeX);
