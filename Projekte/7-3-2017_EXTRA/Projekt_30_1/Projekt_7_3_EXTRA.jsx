...
if(panicPoints > 8)
{
  ...
  b.fill(dominantColors[3]);
    ...
    Panic ( 1, ((b.width - 24)/4)/4, (((b.width - 24)/4)/4)/2, (((b.width - 24)/4)/4)/2, (((b.width - 24)/4)/4)/2, 10, b.height - 2 * ((((b.width - 24)/4)/4)/2), 8, 1, dominantColors  );
...
} else if (panicPoints > 6)
{
  ...
  b.fill(dominantColors[3]);
    ...
    Panic ( 2, ((b.width - 24)/4)/4, (((b.width - 24)/4)/4)/2, (((b.width - 24)/4)/4)/2, (((b.width - 24)/4)/4)/2, (((b.width - 24)/4)/4)/2, b.height/5 - 1.25 * ((((b.width - 24)/4)/4)/2), 8, 5, dominantColors);
    //( v, itemWidth, BeginX, BeginY, itemDistanceX, itemDistanceY,itemHeight, itemsX, itemsY, dominantColors)
...
} else if (panicPoints > 3)
{
  ...
  b.fill(dominantColors[0]);
    ...
    Panic ( 3, ((b.width - 24)/4)/4, (((b.width - 24)/4)/4)/2,  (((b.width - 24)/4)/4)/2,  (((b.width - 24)/4)/4)/2, 80, b.height/5 - 4 * ((((b.width - 24)/4)/4)/2), 8, 5, dominantColors);
    //( v, itemWidth, BeginX, BeginY, itemDistanceX, itemDistanceY,itemHeight, itemsX, itemsY, dominantColors)
...
} else if (panicPoints > 1)
{
    ...
    Panic ( 4, ((b.width - 24)/4)/4, ( ((b.width - 24)/4)/4)/2, ( ((b.width - 24)/4)/4)/2, ( ((b.width - 24)/4)/4)/2, 125, b.height/5 - 6 * (( ((b.width - 24)/4)/4)/2), 8, 5, dominantColors); //( v, itemWidth, BeginX, BeginY, itemDistanceX, itemDistanceY,itemHeight, itemsX, itemsY, dominantColors)
}
